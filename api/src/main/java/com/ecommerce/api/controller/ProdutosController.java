...
public class ProdutosController {
    ...
    @GetMapping("/search")
    public ResponseEntity<List<ProdutosModel>> buscarPorNome(@RequestParam String nome) {
        System.out.println("Buscando por nome: " + nome);  // Adicionei um log para ver o nome recebido
        List<ProdutosModel> produtos = repo.findByNomeContainingIgnoreCase(nome);
        System.out.println("Produtos encontrados: " + produtos.size());  // Log para verificar o número de produtos encontrados
